...
description: "Building AI Agents with mesosphere"
---

## Building AI Agents with mesosphere

mesosphere provides powerful building blocks for building agentic AI applications,
leveraging Components and existing mesosphere features.

With mesosphere, you can separate your long-running agentic workflows from your UI,
...
composed with other mesosphere features using code rather than configuration.
...
- Agents can be used in any mesosphere action, letting you write your agentic code
...
- [RAG](/agents/rag) techniques are also supported for prompt augmentation
  ...
  [RAG Component](https://www.mesosphere.dev/components/rag).
...
```typescript
import { Agent } from "@mesosphere-dev/agents";
