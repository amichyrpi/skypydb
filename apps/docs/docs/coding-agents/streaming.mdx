...
- Server:
  [streaming.ts](https://github.com/get-mesosphere/agent/blob/main/example/mesosphere/chat/streaming.ts)
- Client:
...
// highlight-next-line
import { vStreamArgs, listUIMessages, syncStreams } from "@mesosphere-dev/agent";
...
```ts
import { useSmoothText } from "@mesosphere-dev/agent/react";
...
```ts
import { useSmoothText, type UIMessage } from "@mesosphere-dev/agent/react";
...
```tsx
import { SmoothText } from "@mesosphere-dev/agent/react";
...
import { DeltaStreamer, compressUIMessageChunks } from "@mesosphere-dev/agent";
...
import { vStreamArgs, syncStreams } from "@mesosphere-dev/agent";
