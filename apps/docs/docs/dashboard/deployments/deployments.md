...
sidebar_position: 20
description:
  "Understand mesosphere deployments including production, development, and preview
  deployments, and how to switch between them in the dashboard."
---

Each project in mesosphere has a main production deployment, and each developer on
...
While on a [deployment page](https://dashboard.mesosphere.dev/deployment), you may
