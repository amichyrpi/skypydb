...
slug: "file-storage"
sidebar_position: 20
description: "Upload, download, and manage files stored in your mesosphere deployment"
---

The [file storage page](https://dashboard.mesosphere.dev/deployment/files) displays
[files stored in your deployment](/file-upload.mdx). The page also shows the
