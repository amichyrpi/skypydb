...
sidebar_position: 0
description:
  "Monitor your mesosphere deployment health including failure rates, cache
  performance, scheduler status, and deployment insights for optimization."
---

The [health page](https://dashboard.mesosphere.dev/deployment/) is the landing page
...
Integrations are only available on mesosphere Professional.
