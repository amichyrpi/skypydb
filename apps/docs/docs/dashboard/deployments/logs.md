...
slug: "logs"
sidebar_position: 40
description: "View real-time function logs and deployment activity in your dashboard"
---

![Logs Dashboard Page](/screenshots/logs.png)

The [logs page](https://dashboard.mesosphere.dev/deployment/logs) is a realtime view
...
[mesosphere request id](/functions/error-handling/error-handling.mdx#debugging-errors).
...
[Logs](/dashboard/deployments/logs.md) page of your mesosphere dashboard. Note that
