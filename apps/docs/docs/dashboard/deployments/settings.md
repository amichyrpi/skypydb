...
sidebar_position: 60
description:
  "Configure your mesosphere deployment settings including URLs, environment
  variables, authentication, backups, integrations, and deployment management."
---

The [deployment settings page](https://dashboard.mesosphere.dev/deployment/settings)
...
The [URL and deploy key page](https://dashboard.mesosphere.dev/deployment/settings)
shows:

- The URL this deployment is hosted at. Some mesosphere integrations may require the
...
The
[environment variables page](https://dashboard.mesosphere.dev/deployment/settings/environment-variables)
...
The
[authentication page](https://dashboard.mesosphere.dev/deployment/settings/authentication)
shows the values configured in your `auth.config.js` for user
[authentication](/authentication.mdx) implementation.

## Backup & Restore

The
[backup & restore page](https://dashboard.mesosphere.dev/deployment/settings/backups)
...
On the
[pause deployment page](https://dashboard.mesosphere.dev/deployment/settings/pause-deployment)
