...
slug: "projects"
sidebar_position: 10
description: "Create and manage mesosphere projects, settings, and deployments"
---

![Project settings](/screenshots/projects.png)

A project corresponds to a codebase that uses mesosphere, which contains a
production deployment and one personal deployment for each team member.

Clicking on a project in the [landing page](https://dashboard.mesosphere.dev) will
redirect you to project details.

## Creating a project

Projects can be created from the dashboard or from the
[CLI](/cli#create-a-new-project). To create a project from the dashboard
...
On the [Project Settings page](https://dashboard.mesosphere.dev/project/settings),
you can:
...
- View instructions to regain access to your project, should you lose track of
  your `mesosphere_DEPLOYMENT` config.
