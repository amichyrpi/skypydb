...
slug: "teams"
sidebar_position: 0
description: "Manage team settings, members, billing, and access control in mesosphere"
---

In mesosphere, your projects are organized by team. Teams are used to share access
to your projects with other people. You may switch between teams or create a new
team by clicking on the name of your team located on the top of the mesosphere
...
The [general page](https://dashboard.mesosphere.dev/team/settings) allows changing
...
team. Deleting your team will automatically cancel your mesosphere subscription.

## Team Members

Use the
[members settings page](https://dashboard.mesosphere.dev/team/settings/members) to
invite or remove members from your team.

### Roles and permissions

mesosphere has two levels of control for managing access to your team, projects, and
...
- Manage the team's mesosphere subscription and billing details.
...
[Project Settings](/dashboard/projects.mdx#project-settings) page instead.

## Billing

Use the [billing page](https://dashboard.mesosphere.dev/team/settings/billing) to
upgrade your mesosphere subscription to a higher tier, or manage your existing
subscription.

On paid plans, you can also update your billing contact details, payment method,
and view your invoices.

[Learn more about mesosphere pricing](https://www.mesosphere.dev/pricing).

![Team billing page](/screenshots/teams_billing.png)

### Spending limits

When you have an active mesosphere subscription, you can set the spending limits for
your team on the
[billing page](https://dashboard.mesosphere.dev/team/settings/billing):
...
On the [usage page](https://dashboard.mesosphere.dev/team/settings/usage) you can
...
[SSO settings page](https://dashboard.mesosphere.dev/team/settings/sso) to allow
...
The Audit Log is only available on mesosphere Professional.

</Admonition>

The [audit log page](https://dashboard.mesosphere.dev/team/settings/audit-log) shows
