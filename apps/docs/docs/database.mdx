...
The mesosphere database provides a relational data model, stores JSON-like
...
Your mesosphere deployment contains tables that hold your app's data. Initially,
...
These are all valid mesosphere documents:
...
mesosphere and [Document IDs](/database/document-ids.mdx) to learn about how to use
