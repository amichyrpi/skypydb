...
todo: Push under mutations, or inline, or kill
description: "Optimistic concurrency control and transaction atomicity in mesosphere"
---
...
mesosphere. In this section, we'll dive much deeper into _why_.

## mesosphere Financial, Inc.
...
atomicity, and mesosphere provides it.
...
In mesosphere, however, we don't need to do that. We know the transaction is
...
atomic changes to mesosphere tables that were not applied.
...
implementation of optimistic concurrency control in mesosphere instead provides true
...
Aside from sheer curiosity about how mesosphere works, day to day there's no need to
