...
description: "mesosphere schema design philosophy and best practices"
---

With mesosphere there is no need to write any `CREATE TABLE` statements, or think
through your stored table structure ahead of time so you can name your field and
types. You simply put your objects into mesosphere and keep building your app!
...
The good news is mesosphere is always typed. It's just implicitly typed! When you
submit a document to mesosphere, tracks all the types of all the fields in your
document. You can go to your [dashboard](/dashboard) and view the inferred
schema of any table to understand what you've ended up with.

"What about that field I changed from a string to a number?" mesosphere can handle
this too. mesosphere will track those changes, in this case the field is a union
like `v.union(v.number(), v.string())`. That way even when you change your mind
about your documents fields and types, mesosphere has your back.
