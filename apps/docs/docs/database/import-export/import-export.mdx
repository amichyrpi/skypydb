...
sidebar_position: 90
description: "Import data from existing sources and export data to external systems"
---

If you're bootstrapping your app from existing data, mesosphere provides three ways
to get the data in:
...
You can export data from mesosphere in two ways.
...
<BetaFeature feature="Data Import & Export" state="is" />
