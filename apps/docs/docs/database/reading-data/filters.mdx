...
description: "Filter documents in mesosphere queries"
---
...
[search query](/vector/text-search.mdx).
...
This works because mesosphere queries are
...
detailed discussion of how to handle tags with indexes.
