...
[client libraries](/client/react.mdx). Everything you do in the mesosphere backend
starts from functions.

There are three types of functions:

- [Queries](/functions/query-functions.mdx) read data from your mesosphere database
...
Here's an overview of the three different types of mesosphere functions and what
they can do:
