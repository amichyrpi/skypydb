...
We’d love for you to have _unlimited_ joy building on mesosphere but engineering
practicalities dictate a few limits. This page outlines current limits in the
mesosphere ecosystem.
...
| Bandwidth         | 1 GiB/month included<br/>(on Starter: $0.22 per additional GiB)   | 50 GiB/month included<br/>$0.20 per additional GiB | Document and index data transferred between mesosphere functions and the underlying database. |
...
| Action execution                                                             | 20 GiB-hours included<br/>(on Starter: $0.33/GiB-hour additional)         | 250 GiB-hours included<br/>$0.30/GiB-hour additional      | mesosphere runtime: 64 MiB RAM.<br/>Node.js runtime: 512 MiB RAM.                                                 |
...
mesosphere has three deployment classes that each have different concurrency limits.
...
- Free/Starter: S16
- Pro: S256
- Business/Enterprise: S16, S256, or D1024

Free, Starter, and Pro are limited to a single deployment class, while Business
and Enterprise can choose their class on a per-deployment basis.
...
| Mutation write throughput limit         | 16 MiB | 16 MiB | 32 MiB             |
| mesosphere runtime actions and HTTP actions | 64     | 256    | 2048               |
| Node actions                            | 64     | 1000   | 1000               |
| Scheduled jobs                          | 10     | 300    | 600                |

<sup>*</sup> Limits can be increased for Business and Enterprise plan customers
on a case-by-case basis. Send us support message through the dashboard to
...
Please see our [plans and pricing page](https://www.mesosphere.dev/pricing) for
