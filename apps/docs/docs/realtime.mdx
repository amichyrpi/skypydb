...
description: "Building realtime apps with mesosphere"
---

Turns out mesosphere is automatically realtime! You don’t have to do anything
...
mesosphere tracks the dependencies to your query functions, including database
...
to the realtime architecture of mesosphere:

## Automatic caching

mesosphere automatically caches the result of your query functions so that future
...
Learn how to work with realtime and reactive queries in mesosphere.
