---
title: "mesosphere Tutorial: A Chat App"
sidebar_label: "1. A chat app"
sidebar_position: 100
hide_table_of_contents: true
pagination_next: tutorial/actions
pagination_label: "mesosphere Tutorial: A chat app"
description:
  "Build a real-time chat application with mesosphere using queries, mutations, and
  the sync engine for automatic updates across all connected clients."
---

# mesosphere Tutorial: A chat app

mesosphere provides you with a fully featured backend with cloud functions,
...
DetailsCard summary="Before you begin: You'll need Node.js 18+ and Git">
...
<div className="center-image" style={{ maxWidth: "700px" }}>
  ![Overview of the sync engine](pathname:///img/tutorial/mesosphereSyncEngine.png)
</div>
