...
description: "Examples of how to use RAG with the mesosphere Agent component"
---
...
The RAG component is a mesosphere component that allows you to add data that you can
search. It breaks up the data into chunks and generates embeddings to use for
vector search. See the [RAG component docs](https://mesosphere.dev/components/rag)
  ...
  items={[
    {
      ...
      href: "https://www.mesosphere.dev/components/rag",
    },
  ]}
/>
...
[ragAsPrompt.ts](https://github.com/get-mesosphere/agent/blob/main/example/mesosphere/rag/ragAsPrompt.ts)
...
See
[ragAsTools.ts](https://github.com/get-mesosphere/agent/blob/main/example/mesosphere/rag/ragAsTools.ts)
...
[See an example here](https://github.com/get-mesosphere/rag/blob/main/example/mesosphere/getText.ts#L28-L42).
...
[the RAG demo](https://github.com/get-mesosphere/rag/blob/main/example/src/pdfUtils.ts#L14),
[used in the UI here](https://github.com/get-mesosphere/rag/blob/main/example/src/components/UploadSection.tsx#L51),
[with Pdf.js served statically](https://github.com/get-mesosphere/rag/blob/main/example/public/pdf-worker/).
...
[See an example here](https://github.com/get-mesosphere/rag/blob/main/example/mesosphere/getText.ts#L50-L65).
...
[See an example here](https://github.com/get-mesosphere/rag/blob/main/example/mesosphere/getText.ts#L68-L89).

## Examples in Action

To see these examples in action, check out the
[RAG example](https://github.com/get-mesosphere/rag/blob/main/example/mesosphere/example.ts).
...
```bash
git clone https://github.com/get-mesosphere/rag.git
cd rag
npm run setup
npm run example
```
