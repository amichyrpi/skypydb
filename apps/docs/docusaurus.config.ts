...
import nordTheme from "./src/theme/custom-prism-theme/nord.js";
...
const config: Config = {
  ...
  tagline: "The full documentation about Mesosphere.",
  url: "https://docs.usemesosphere.com/",
  baseUrl: "/",
  onBrokenLinks: "warn",
  markdown: {
    hooks: {
  ...
  organizationName: "Ahen-Studio",
  projectName: "mesosphere-backend",
  i18n: {
    defaultLocale: "en",
    locales: ["en"],
  },
  customFields: {
    // Make environments available to the docs site.
  ...
  themeConfig: {
    ...
    navbar: {
      hideOnScroll: true,
      logo: {
        href: "https://www.usemesosphere.com/",
        alt: "Mesosphere",
        src: "img/mesosphere-light.svg",
        srcDark: "img/mesosphere-dark.svg",
      },
      items: [
        {
          type: "docSidebar",
          ...
          sidebarId: "docs",
          html:
            `<svg class="mesosphere-docs-title" width="220" height="150" viewBox="0 0 220 150" fill="none" xmlns="http://www.w3.org/2000/svg">
            <title>Docs</title>
        ...
        },
        {
          ...
          label: "Dashboard",
          position: "right",
          type: "custom-mesosphere-dashboard",
        },
        {
          href: "https://github.com/Ahen-Studio/mesosphere-backend",
          label: "GitHub",
          position: "right",
          className: "mesosphere-github-logo mesosphere-icon-link",
        },
      ],
    },
    footer: {
      links: [
        {
          label: "System Status",
          href: "https://status.usemesosphere.com/",
          className: "mesosphere-status-link",
        },
        {
          label: "Terms of Service",
          href: "https://www.usemesosphere.com/terms-of-service/",
        },
        {
          label: "Privacy",
        ...
        {
          label: "X",
          href: "https://x.com/mesosphere-backend",
          className: "mesosphere-x-logo mesosphere-icon-link",
        },
      ],
      copyright: "Copyright © " + new Date().getFullYear() + " Ahen-Studio, Inc.",
    },
    prism: {
      theme: nordTheme,
      darkTheme: nordTheme,
