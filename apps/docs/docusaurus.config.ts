...
const config: Config = {
  ...
  themeConfig: {
      ...
      items: [
        {
          ...
          position: "left",
          sidebarId: "docs",
          html: `<svg class="mesosphere-docs-title" width="220" height="150" viewBox="0 0 220 150" fill="none" xmlns="http://www.w3.org/2000/svg">
            <title>Docs</title>
    ...
    footer: {
      ...
      copyright:
        "Copyright © " + new Date().getFullYear() + " Ahen-Studio, Inc.",
    },
    prism: {
      theme: nordTheme,
      darkTheme: nordTheme,
