/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 324b67540f56f0afb05310cc4563f3cf)
...
declare namespace Cloudflare {
  interface Env {
    ...
    ASSETS: Fetcher;
    NEXTJS_ENV: string;
    WORKER_SELF_REFERENCE: Fetcher /* us-dashboard */;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends Partial<
    StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV">>
  > {}
}
