...
Use the Mesosphere CLI to push your functions to the server (cloud or self-hosted).
See everything the Mesosphere CLI can do by running `npx mesosphere --help` in your project root directory.
