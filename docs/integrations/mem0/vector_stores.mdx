...
File to change and or add:

<Tree>
  <Tree.Folder name="vector_stores" defaultOpen>
    <Tree.File name="configs.py" />
    <Tree.File name="skypydb.py" />
  </Tree.Folder>
</Tree>

<Steps titleSize="h3">
  <Step title="configs.py">
    ```python Python
