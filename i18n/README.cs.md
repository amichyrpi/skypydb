...
[Mesosphere](https://www.usemesosphere.com/) je open-source relační a vektorová databáze pro vkládání s licencí Apache 2.0 a je navržena tak, aby byla jednoduchá, rychlá a snadno použitelná pro webové vývojáře a backendové vývojáře. Čtěte, zapisujte data a provádějte tvrdou logiku zápisem funkcí v Typescript s plnou bezpečností typu.
...
Hledáte svůj jazyk? Najdete ho na [languages](./languages.md)

## Dokumentace

Úplnou dokumentaci naleznete na adrese [docs.usemesosphere.com](https://docs.usemesosphere.com/)
...
- [GitHub Issues](https://github.com/Ahen-Studio/mesosphere-backend/issues). Nejlepší pro: chyby a chyby, na které narazíte při používání Mesosphere.
- [Github Pull Requests](https://github.com/Ahen-Studio/mesosphere-backend/pulls). Nejlepší pro: přispívání do kódové základny.

## Testovací zóna

Chcete-li experimentovat s funkcemi Mesosphere a dozvědět se, jak fungují, navštivte [Testovací zóna](.../mesosphere-tests/).
