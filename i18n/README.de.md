...
[Mesosphere](https://www.usemesosphere.com/) ist eine Open-Source-Datenbank für relationale Datenbanken und Vektoreinbettungen mit einer Apache 2.0-Lizenz. Sie ist so konzipiert, dass sie für Webentwickler und Backend-Entwickler einfach, schnell und benutzerfreundlich ist. Lesen und schreiben Sie Daten und führen Sie harte Logik durch, indem Sie Funktionen in Typescript mit vollständiger Typsicherheit schreiben.
...
Suchen Sie Ihre Sprache? Sie finden es unter [languages](./languages.md)

## Dokumentation

Die vollständige Dokumentation finden Sie unter [docs.usemesosphere.com](https://docs.usemesosphere.com/).
...
- [GitHub Issues](https://github.com/Ahen-Studio/mesosphere-backend/issues). Am besten geeignet für: Bugs und Irrtümer, die bei der Verwendung von Mesosphere auftreten.
- [Github Pull Requests](https://github.com/Ahen-Studio/mesosphere-backend/pulls). Am besten geeignet für: Beitrag zur Codebasis.

## Testzone

Um mit den Funktionen von Mesosphere zu experimentieren und zu erfahren, wie sie funktionieren, besuchen Sie [Testzone](.../mesosphere-tests/).
