...
<p align="center">
    <b>mesosphere-backend – avatud lähtekoodiga relatsiooni- ja vektormanustuste andmebaas</b>. <br />
</p>
...
- Relatsioon: looge oma funktsioonid ja salvestage andmed relatsiooniandmebaasi.

- Vektori manustamine: looge, otsige ja kustutage vektorkogusid.

- Failide salvestusruum: salvestage failid andmebaasi.

- Mälu: lisage LLM-ile mälu, kasutades [mem0](https://github.com/mem0ai/mem0) ja meie [integration](./demo/integration/mem0/).

- Tasuta ja avatud lähtekoodiga: Apache 2.0 litsentsitud

- Platvormideülene: Windows, Linux, MacOS

## Httpkliendid

### TypeScript

Mesosphere pakub andmebaasiga suhtlemiseks TypeScript klienti, saate kasutada kas vektormanuste andmebaasi või relatsiooniandmebaasi. Kõigepealt vaatame, kuidas kasutada vektormanustuste andmebaasi.

#### Vektormudel

Oma vektormanustuste loomiseks saate kasutada puu AI mudelite pakkujat.

- [x] HuggingFace Sentence Transformers
- [x] Ollama
- [x] OpenAI

Siin on näide selle kaitsva teenusepakkuja kasutamise kohta.
...
Pärast kliendi loomist saate seda kasutada andmebaasiga suhtlemiseks.

Lisage andmed oma vektorite andmebaasi.
...
Kustutage andmed oma vektorite andmebaasist.
...
Andmete päring vektori andmebaasist.
...
Näiteks relatsioonifunktsioonide kasutamise kohta vaadake kausta [examples](./demo/examples/js/relational_examples/).

Näiteks failide salvestusfunktsioonide kasutamise kohta vaadake kausta [examples](./demo/examples/js/files_upload_examples/).

Lisateavet leiate meie [Docs](https://docs.ahen-studio.com/)

### Python

Mesosphere pakub andmebaasiga suhtlemiseks Python klienti, saate kasutada kas vektormanustatud andmebaasi või relatsiooniandmebaasi. Kõigepealt vaatame, kuidas kasutada vektormanustuste andmebaasi.
...
Näiteks relatsioonifunktsioonide kasutamise kohta vaadake kausta [examples](./demo/examples/python/relational_examples/).

Praegu pythoni klient failide salvestamise funktsiooni ei toeta.

#### Integratsioon

Python klient pakub võimalust lisada tehisintellektile mälu [mem0](https://github.com/mem0ai/mem0) ja meie [integration](./demo/integration/mem0/) abil.

Lisateavet leiate meie [Docs](https://docs.ahen-studio.com/)

## Kõik tänu meie kaastöötajatele:
