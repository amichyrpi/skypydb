...
<p align="center">
    <b>mesosfera-backend - baza danych o osadzaniu relacyjnym i wektorowym typu open source</b>. <br />
</p>
...
- Relacyjny: twórz swoje funkcje i przechowuj dane w relacyjnej bazie danych.

- Osadzanie wektorów: tworzenie, wyszukiwanie i usuwanie kolekcji wektorów.

- Przechowywanie plików: przechowuj swoje pliki w bazie danych.

- Pamięć: dodaj pamięć do LLM, używając [mem0](https://github.com/mem0ai/mem0) i naszego [integration](./demo/integration/mem0/).

- Bezpłatne i otwarte oprogramowanie: licencja Apache 2.0
...
Mesosfera oferuje klienta TypeScript do interakcji z bazą danych, możesz użyć bazy danych osadzania wektorów lub relacyjnej bazy danych. Najpierw przyjrzymy się, jak korzystać z bazy danych osadzania wektorów.

#### Model wektorowy

Możesz użyć dostawcy modeli drzew AI, aby utworzyć osadzanie wektorów.

- [x] HuggingFace Sentence Transformers
- [x] Ollama
- [x] OpenAI

Oto przykład korzystania z tego odmiennego dostawcy.
...
Po utworzeniu klienta można go używać do interakcji z bazą danych.

Dodaj dane do swojej bazy wektorów.
...
Usuń dane z bazy danych wektorów.
...
Zapytaj o dane z bazy danych wektorów.
...
Na przykład użycie funkcji relacyjnych sprawdź folder [examples](./demo/examples/js/relational_examples/).

Na przykład wykorzystanie funkcji przechowywania plików, sprawdź folder [examples](./demo/examples/js/files_upload_examples/).

Dowiedz się więcej na naszym [Docs](https://docs.ahen-studio.com/)

### Python

Mesosfera oferuje klienta Python do interakcji z bazą danych. Można używać albo bazy danych wektorów, albo relacyjnej bazy danych. Najpierw przyjrzymy się, jak korzystać z bazy danych osadzania wektorów.
...
Na przykład użycie funkcji relacyjnych sprawdź folder [examples](./demo/examples/python/relational_examples/).

Na razie klient Pythona nie obsługuje funkcji przechowywania plików.

#### Integracja

Klient Python oferuje możliwość dodania pamięci do sztucznej inteligencji za pomocą [mem0](https://github.com/mem0ai/mem0) i naszego [integration](./demo/integration/mem0/).

Dowiedz się więcej na naszym [Docs](https://docs.ahen-studio.com/)

## Wszystko dzięki naszym współtwórcom:
