...
[Mesosphere](https://mesosphere.ahen-studio.com) är en relations- och vektorinbäddningsdatabas med öppen källkod med en Apache 2.0-licensierad. Den är designad för att vara enkel, snabb och lätt att använda för webbutvecklare och backend-utvecklare. Läs, skriv data och utför hård logik genom att skriva funktioner i Typescript med full typsäkerhet.
...
Letar du efter ditt språk? Du hittar den på [languages](./i18n/languages.md)

## Dokumentation

För fullständig dokumentation, besök [mesosphere.ahen-studio.com/docs](https://mesosphere.ahen-studio.com/docs)
...
- [GitHub Issues](https://github.com/Ahen-Studio/mesosphere-backend/issues). Bäst för: buggar och fel du stöter på när du använder Supabase.
