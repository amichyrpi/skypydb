...
<p align="center">
    <b>mesosphere-backend - Relations- och vektorinbäddningsdatabas med öppen källkod</b>. <br />
</p>
...
- Relationell: skapa dina funktioner och lagra dina data i en relationsdatabas.

- Vektorinbäddningar: skapa, sök och ta bort vektorsamlingar.

- Fillagring: lagra dina filer i en databas.

- Minne: lägg till minne till en LLM genom att använda [mem0](https://github.com/mem0ai/mem0) och vår [integration](./demo/integration/mem0/).

- Gratis & öppen källkod: Apache 2.0 Licensierad

- Plattformsoberoende: Windows, Linux, MacOS

## HttpClients

### TypeScript

Mesosphere erbjuder en TypeScript-klient för att interagera med databasen, du kan använda antingen vektorinbäddningsdatabasen eller relationsdatabasen. Vi ska först titta på hur man använder databasen för vektorinbäddningar.

#### Vektormodell

Du kan använda leverantören av träd AI-modeller för att skapa dina vektorinbäddningar.

- [x] HuggingFace Sentence Transformers
- [x] Ollama
- [x] OpenAI

Här är ett exempel på hur man använder denna deferenta leverantör.
...
När du har skapat klienten kan du använda den för att interagera med databasen.

Lägg till data till din vektordatabas.
...
Ta bort data från din vektordatabas.
...
Fråga data från din vektordatabas.
...
Till exempel användning av relationsfunktionerna, kolla in mappen [examples](./demo/examples/js/relational_examples/).

Till exempel användning av fillagringsfunktionerna, kolla in mappen [examples](./demo/examples/js/files_upload_examples/).

Läs mer på vår [Docs](https://docs.ahen-studio.com/)

### Python

Mesosphere erbjuder en Python-klient för att interagera med databasen, du kan använda antingen vektorinbäddningsdatabasen eller relationsdatabasen. Vi ska först titta på hur man använder databasen för vektorinbäddningar.
...
Till exempel användning av relationsfunktionerna, kolla in mappen [examples](./demo/examples/python/relational_examples/).

För närvarande stöder inte python-klienten fillagringsfunktionen.

#### Integration

Python-klienten erbjuder dig möjligheten att lägga till minne till en AI med [mem0](https://github.com/mem0ai/mem0) och vår [integration](./demo/integration/mem0/).
