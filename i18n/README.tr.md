...
Dilinizi mi arıyorsunuz? [languages](./languages.md) adresinde bulacaksınız

## Dokümantasyon

Belgelerin tamamı için [docs.usemesosphere.com](https://docs.usemesosphere.com/) adresini ziyaret edin
...
- [GitHub Issues](https://github.com/Ahen-Studio/mesosphere-backend/issues). Şunun için en iyisi: Mesosphere'i kullanırken karşılaştığınız hatalar ve hatalar.
- [Github Pull Requests](https://github.com/Ahen-Studio/mesosphere-backend/pulls). En iyisi: kod tabanına katkıda bulunmak.

## Test Bölgesi

Mesosphere özelliklerini denemek ve nasıl çalıştıklarını öğrenmek için [Test Bölgesi](../mesosphere-tests/) adresini ziyaret edin.
