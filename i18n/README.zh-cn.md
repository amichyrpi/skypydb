...
[Mesosphere](https://mesosphere.ahen-studio.com) 是一个获得 Apache 2.0 许可的开源关系和向量嵌入数据库，其设计简单、快速且易于 Web 开发人员和后端开发人员使用。通过在具有完全类型安全性的 Typescript 中编写函数来读取、写入数据并执行硬逻辑。
...
正在寻找您的语言？您可以在 [languages](./i18n/languages.md) 找到它

## 文档

如需完整文档，请访问 [mesosphere.ahen-studio.com/docs](https://mesosphere.ahen-studio.com/docs)
...
- [GitHub Issues](https://github.com/Ahen-Studio/mesosphere-backend/issues). 最适合：使用 Supabase 遇到的错误和错误。
