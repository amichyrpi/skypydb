...
import { ClientUtilitiesMixin } from "./operations/vector";
import { VectorDatabase } from "../database/vector_database";
...
class VectorClientBase extends ClientUtilitiesMixin {}

/**
 * Public vector client used by application code to manage collections and items.
 */
export class VectorClient extends VectorClientBase {
...
/**
 * Backward compatible alias for existing users importing `vecClient`.
 */
export class vecClient extends VectorClient {}
