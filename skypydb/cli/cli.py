...
class SkypyCLI:
    ...
    def __init__(
        ...
        repo_zip_url: str = "https://github.com/Ahen-Studio/skypydb/archive/refs/heads/main.zip",
    ...
    def init_project(self) -> None:
        ...
        print("Give us feedback at https://github.com/Ahen-Studio/skypydb/issues")
